...
makedocs(;
    ...
    pages=[
        ...
        "Modules" => [
            ...
            "Clonoquery" => "modules/clonoquery.md",
            "Allele Usage" => "modules/plotalleles.md",
            "Upstream Analysis" => "modules/upstream.md",
            "Expression Counts" => "modules/count.md",
            "Database Comparison" => "modules/dbdiff.md",
            "Haplotype Analysis" => "modules/haplotype.md",
            "Cluster Visualization" => "modules/clusterplot.md",
            "Dereplicate" => "modules/dereplicate.md",
            "Read Merging" => "modules/merge.md",
            "Sequence Union" => "modules/union.md",
